...
struct CoreRoutingTestRunner {
    static func main() {
        ...
        check("Chrome Control horizontal positive delta switches to next tab and swallows", ScrollEventModel(frontmostBundleID: "com.google.Chrome", horizontalDelta: 1, verticalDelta: 0, modifiers: [.control]), .nextTabAndSwallow)
        check("Chrome Control horizontal negative delta switches to previous tab and swallows", ScrollEventModel(frontmostBundleID: "com.google.Chrome", horizontalDelta: -1, verticalDelta: 0, modifiers: [.control]), .previousTabAndSwallow)
        ...
        check("Chrome Control+Option horizontal passes through", ScrollEventModel(frontmostBundleID: "com.google.Chrome", horizontalDelta: 1, verticalDelta: 0, modifiers: [.control, .option]), .passThrough)
