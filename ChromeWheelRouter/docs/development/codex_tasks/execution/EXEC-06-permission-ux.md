...
- Update `ChromeWheelRouter/docs/product/USER_GUIDE.md` with first-run permission steps.
- Update `ChromeWheelRouter/docs/product/TROUBLESHOOTING.md` with permission problems.
